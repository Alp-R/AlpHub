...
sethiddenproperty(Players,'MaximumSimulationRadius',math.huge-math.huge)
sethiddenproperty(Players,'SimulationRadius',math.huge-math.huge)end end
sethiddenproperty(game:GetService("Players").LocalPlayer,'MaximumSimulationRadius',math.huge*math.huge)
